...
const NODES = [
  ...
  { name: "ALA", lat: 43.24, lon: 76.95 },    // 40  Almaty — Central Asia
]

const CONNECTIONS: [number, number][] = [
  // ── North America ──
  [0, 1],   [0, 18],  [0, 15],  [1, 20],
  [1, 16],  [15, 16], [18, 38], [20, 39],
  [21, 32], [38, 39],
  // ── Transatlantic (Atlantic ocean arcs) ──
  [1, 2],   [22, 21], [16, 3],  [1, 22],
  // ── Europe ──
  [2, 3],   [3, 4],   [4, 25],  [2, 22],
  [23, 17], [24, 25], [25, 26], [4, 17],
  // ── Europe → East ──
  [26, 10], [4, 9],   [9, 40],
  // ── Africa & Middle East ──
  [10, 27], [27, 28], [28, 19], [29, 28],
  [29, 22],
  // ── Central & South Asia ──
  [10, 11], [11, 14], [14, 40], [40, 9],
  [40, 14], [14, 30],
  // ── East & Southeast Asia ──
  [30, 6],  [5, 31],  [5, 7],   [6, 37],
  [7, 31],  [30, 7],  [31, 37],
  // ── South America ──
  [21, 12], [12, 13], [32, 33], [13, 34],
  [33, 34],
  // ── Oceania ──
  [8, 35],  [36, 6],  [8, 36],  [35, 8],
  // ── Trans-Pacific (Pacific ocean arcs — visible on ocean face) ──
  [0, 5],   [18, 5],  [15, 31], [18, 7],
  [31, 0],  [5, 35],  [8, 34],  [37, 35],
  // ── Trans-Atlantic long-haul (Atlantic ocean arcs) ──
  [12, 29], [39, 12], [21, 29], [12, 19],
  // ── Cross-continent long-haul ──
  [6, 8],   [19, 29], [2, 11],  [9, 5],
]
